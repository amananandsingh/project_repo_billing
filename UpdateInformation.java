...
public class UpdateInformation extends JFrame implements ActionListener{
	...
	UpdateInformation(String meter) {
		...
		update.setBackground(Color.BLACK);//cancel bbutton
		...
		cancel.setBackground(Color.BLACK);//cancel bbutton
	...
	public void actionPerformed(ActionEvent ae) {
		if(ae.getSource()==update) {
			...
			try {Conn c= new Conn();
			c.s.executeUpdate("update customer set address='"+address+"', city='"+city+"',state='"+state+"',phone='"+phone+"',email='"+email+"' where meter_no='"+meter+"' ");
			JOptionPane.showMessageDialog(null,"User Information Updated Successsfully");
			setVisible(false);
