...
import java.util.*;
public class MeterInfo extends JFrame implements ActionListener{      //action listener is implemented due to implement the button
	...
	MeterInfo(String meternumber){
		...
		JLabel lbmeternumber=new JLabel(meternumber);   //here string is put in jlabel
		...
		lblphones.setBounds(200,320,500,20);
		p.add(lblphones);		
	...
	public void actionPerformed(ActionEvent ae) { //to perform action on click
	if(ae.getSource()==next) {
		...
		try {
			...
			JOptionPane.showMessageDialog(null, "MeterInfo Added Successfully");
						setVisible(false);
